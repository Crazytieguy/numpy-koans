window.KOANS_RESHAPING = [
    {
        ...
        solution: "(2, 3)",
        test: "",
        hint: "reshape(2, 3) creates 2 rows and 3 columns. The shape is exactly the arguments you passed."
    },
    {
        id: "reshaping_2",
        title: "Reshape Preserves Contents",
        description: "New form, same spirit -- nothing is lost in transformation.",
        code: "a = np.arange(6)\nb = a.reshape(2, 3)\nassert b.tolist() == __",
    ...
    {
        id: "reshaping_7",
        title: "Transpose Swaps Elements",
    ...
    },
    {
        ...
        description: "The river and the lake hold the same water, yet one has depth the other does not.",
        code: "a = np.array([1, 2, 3])\nb = np.array([4, 5, 6])\nc = np.stack([a, b])\nassert c.shape == __",
        solution: "(2, 3)",
        test: "",
        hint: "stack creates a NEW dimension. Two arrays of shape (3,) become one array of shape (2, 3). Compare: concatenate would give (6,)."
    }
];
